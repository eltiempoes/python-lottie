...
dr = anutils.DepthRotationDisplacer(NVector(256, 256, 0), 30, 90, 10, NVector(0, 4, 1), 0, -60)
dr.animate_point(eye1.position)
dr.animate_point(eye2.position)
dr.animate_point(nose.position)
dr.animate_bezier(mouth.vertices)

dr = anutils.DepthRotationDisplacer(NVector(256, 256, 0), 90, 120, 10, NVector(0, 4, 1), 0, 30)
dr.animate_point(eye1.position)
dr.animate_point(eye2.position)
dr.animate_point(nose.position)
dr.animate_bezier(mouth.vertices)
