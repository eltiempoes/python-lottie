...
circle.position.add_keyframe(0, NVector(0, 256))
circle.position.add_keyframe(20, NVector(256, 256))
circle.position.add_keyframe(40, NVector(256, 0))
circle.position.add_keyframe(60, NVector(0, 256))
